<div class="flex items-center p-3 gap-3" >
    <button
        x-data="{
            ...
            toggleTheme() {
                ...
                $dispatch('toggle-theme', this.darkMode);
            }
        }"
        @click="toggleTheme"
        type="button"
        class="relative inline-flex flex-shrink-0 h-6 transition-colors duration-200 ease-in-out border-2 border-transparent rounded-full cursor-pointer bg-zinc-200 dark:bg-zinc-700 w-11 dark:ring-2 dark:ring-neutral-700 dark:ring-offset-2 focus:outline-none focus:ring-2 focus:ring-neutral-700 focus:ring-offset-2"
        role="switch"
        aria-checked="false"
    >
    ...
    <span class="text-sm text-gray-500 dark:text-zinc-200" >
        Dark Mode
    </span >
</div >
